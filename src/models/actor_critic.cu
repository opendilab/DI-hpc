...
void actor_critic_update_ae(
    ...
    int64_t input_dim = key_embeddings.size(2);
    {
        ...
        autoregressive_embedding_fp<<<grid_size, block_size>>>(batch_size, max_entity_num, input_dim,
                (int64_t*)(sample_entity.data_ptr()), (int64_t*)(entity_num.data_ptr()),
                (float*)(key_embeddings.data_ptr()), (float*)(autoregressive_embedding.data_ptr()));
    }
}
...
void actor_critic_lstm_activation(
    ...
    int64_t hidden_size = lstm_ih.size(1) / 4;
    {
        ...
        lstm_activation_fp<<<grid_size, block_size>>>(batch_size, hidden_size,
                (float*)(lstm_ih.data_ptr()), (float*)(lstm_hh.data_ptr()), (float*)(lstm_bias.data_ptr()),
                (float*)(lstm_hx.data_ptr()), (float*)(lstm_cx.data_ptr()));
    }
}
...
void actor_critic_pre_sample(
    ...
    int64_t hidden_size = mat.size(2);
    {
        ...
        pre_sample_fp<<<grid_size, block_size>>>(batch_size, max_entity_num, hidden_size, mask_value, div_factor,
                (float*)(mat.data_ptr()), (float*)(vec.data_ptr()), (bool*)(mask.data_ptr()),
